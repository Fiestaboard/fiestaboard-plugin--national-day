...
- **Holiday changes at the wrong time** — verify the timezone under FiestaBoard's general settings. National Day falls back to the Date & Time plugin timezone, then UTC.
